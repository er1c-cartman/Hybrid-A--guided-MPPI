...
: rclcpp::Node ("ahrs_bringup")
{
  ...
  this->declare_parameter<std::string>("serial_port_","/dev/ttyUSB0");  //Modified LimJH
  ...
  //gps_pub_ = create_publisher<sensor_msgs::msg::NavSatFix>(gps_topic.c_str(), 10);  //Del LimJH
